...
const Canvas=({code,title,children}:{code:string;title:string;children:ReactNode})=><AbsoluteFill style={{overflow:'hidden',backgroundColor:C.paper,color:C.ink,fontFamily: 'var(--inkloom-animation-body)'}}>
  ...
  <h1 style={{fontFamily: 'var(--inkloom-animation-title)', position:'absolute',left:70,top:72,margin:0,fontSize:56,lineHeight:1.05,fontWeight:900}}>{title}</h1><div style={{position:'absolute',left:70,right:70,top:158,height:4,backgroundColor:C.ink}}/>{children}
