      ...
      >
        <Enter delay={6} marker="five-points-panel" style={{position: 'absolute', left: 0, top: 0, width: 876, height: 744}}>
          <Panel tone={C.siren} watermark={<Zap size={180} color={C.siren} strokeWidth={1.6} />} style={{height: '100%', padding: '14px 18px', display: 'flex', flexDirection: 'column', gap: 8}}>
            ...
            <IconChip icon={<Users size={26} color={C.white} strokeWidth={2.2} />} tone={C.chart2} title="③ 危险样态＝危及多数人：">
              刀刺多名学生→数个故意伤害罪∉本罪
            </IconChip>
            <IconChip icon={<Scale size={26} color={C.white} strokeWidth={2.2} />} tone={C.amber} title="④ 危险程度＝与放火罪相同：">
              高速路小火堆→达不到放火程度也达不到本罪
            </IconChip>
            <IconChip icon={<Gavel size={26} color={C.white} strokeWidth={2.2} />} tone={C.ward} title="⑤ 适用顺序＝补充罪名：">
        ...
        <Enter delay={18} marker="seven-ways-panel" style={{position: 'absolute', left: 900, top: 0, width: 876, height: 234}}>
          <Panel tone={C.amber} watermark={<Zap size={150} color={C.amber} strokeWidth={1.6} />} style={{height: '100%', padding: '12px 16px', display: 'flex', flexDirection: 'column', gap: 7}}>
            <TabChip tone={C.amber} icon={<Zap size={24} color={C.white} strokeWidth={2.2} />}>七情形（司法解释）</TabChip>
        ...
        <Enter delay={30} marker="destruction-panel" style={{position: 'absolute', left: 900, top: 258, width: 876, height: 486}}>
          <Panel tone={C.chart2} watermark={<Scale size={160} color={C.chart2} strokeWidth={1.6} />} style={{height: '100%', padding: '14px 18px', display: 'flex', flexDirection: 'column', gap: 8}}>
            <TabChip tone={C.chart2} icon={<Scale size={24} color={C.white} strokeWidth={2.2} />}>破坏型犯罪（交通工具·设施·电力）</TabChip>
            <IconChip icon={<Zap size={24} color={C.white} strokeWidth={2.2} />} tone={C.pulse} title="破坏交通工具罪：">
              破坏刹车→∈（足以倾覆）；破坏座椅∉；卸全部车轮∉（已躺地）
            </IconChip>
            <IconChip icon={<Gavel size={24} color={C.white} strokeWidth={2.2} />} tone={C.ward} title="破坏交通设施罪：">
