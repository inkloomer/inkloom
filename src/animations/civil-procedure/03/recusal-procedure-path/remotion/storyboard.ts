...
export const SCENES = {
  scope: slowScene(0, 270),
  timing: slowScene(270, 240),
  pendingEffect: slowScene(510, 270),
  decision: slowScene(780, 300),
  remedy: slowScene(1080, 270),
  pauseVsContinue: slowScene(1350, 450),
} as const;
