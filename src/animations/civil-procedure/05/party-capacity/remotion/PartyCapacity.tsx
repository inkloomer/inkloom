...
import {CaseScene, ComparisonScene, DefinitionScene, RecapScene} from './scenes/CapacityScenes';
...
export const PartyCapacity = () => {
  ...
  return (
    <AbsoluteFill style={{backgroundColor: PALETTE.background, overflow: 'hidden'}}>
      ...
      <SceneSequence name="03-case" {...SCENES.case}>
        <CaseScene />
      </SceneSequence>
