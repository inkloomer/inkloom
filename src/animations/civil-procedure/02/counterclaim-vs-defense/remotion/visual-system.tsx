...
export const CaseCard = ({
  ...
  >
    <div style={{fontSize: 22, fontWeight: 800, color: PALETTE.muted, marginBottom: 10}}>{title}</div>
    <div style={{fontSize: 32, fontWeight: 900, color: accentColor(accent), marginBottom: 12}}>{result}</div>
    <div style={{fontSize: 20, color: PALETTE.ink, lineHeight: 1.5}}>{reason}</div>
  </div>
);
...
export const DecisionNode = ({
  ...
  >
    <div style={{fontSize: 28, fontWeight: 900, color: accentColor(accent), textAlign: 'center'}}>{label}</div>
    {detail ? <div style={{marginTop: 8, fontSize: 18, color: PALETTE.muted, fontWeight: 650, textAlign: 'center'}}>{detail}</div> : null}
  </div>
);
