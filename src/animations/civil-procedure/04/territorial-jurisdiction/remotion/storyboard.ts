...
export const SCENES = {
  orientation: slowScene(0, 180),
  general: slowScene(180, 270),
  special: slowScene(450, 300),
  exclusive: slowScene(750, 300),
  agreement: slowScene(1050, 270),
  threestep: slowScene(1320, 480),
} as const;
