...
export const TerritorialJurisdiction = () => {
  ...
  return (
    <AbsoluteFill style={{backgroundColor: PALETTE.background, overflow: 'hidden'}}>
      <BackgroundStructure />
      <SceneSequence name="01-orientation" {...SCENES.orientation}>
        <OrientationScene />
      </SceneSequence>
      <SceneSequence name="02-general" {...SCENES.general}>
        <GeneralScene />
      </SceneSequence>
      <SceneSequence name="03-special" {...SCENES.special}>
        <SpecialScene />
      </SceneSequence>
      <SceneSequence name="04-exclusive" {...SCENES.exclusive}>
        <ExclusiveScene />
      </SceneSequence>
      <SceneSequence name="05-agreement" {...SCENES.agreement}>
        <AgreementScene />
      </SceneSequence>
      <SceneSequence name="06-threestep" {...SCENES.threestep}>
        <ThreeStepScene />
      </SceneSequence>
