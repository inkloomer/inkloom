...
export const ConceptScene = () => {
  ...
  return <div style={{position: 'absolute', inset: 0}}>
    ...
    <MaskedReveal delay={16} duration={24} style={{position: 'absolute', left: 112, top: 278, width: 540}}><div style={{...{color: PALETTE.ink, fontSize: 29, lineHeight: 1.42}, fontFamily: 'Arial Narrow, Microsoft YaHei, sans-serif'}}>第三人没有参加原诉，<br /><Keyword accent="vermilion">生效裁判却压到了他的权益</Keyword>。</div></MaskedReveal>
    ...
    <div style={{position: 'absolute', left: 700, top: 785, color: PALETTE.muted, fontFamily: 'Consolas, monospace', fontSize: 22}}>NEW PLATE / 第三人撤销之诉</div>
  </div>;
};
...
export const ConditionsScene = () => {
  ...
  return <div style={{position: 'absolute', inset: 0}}>
    ...
    <div style={{position: 'absolute', left: 120, top: 130, color: PALETTE.muted, fontFamily: 'Consolas, monospace', fontSize: 22}}>四种颜色必须在同一张起诉文书上套准 / REGISTER AS ONE</div>
...
export const ProcedureScene = () => {
  ...
  return <div style={{position: 'absolute', inset: 0}}>
    ...
    <div style={{position: 'absolute', left: 150, top: 650, width: 1600, display: 'flex', justifyContent: 'space-between', color: PALETTE.muted, fontFamily: 'Consolas, monospace', fontSize: 16}}><span>KNOW / SHOULD KNOW</span><span>FINAL JUDGMENT COURT</span><span>APPEALABLE JUDGMENT</span></div>
