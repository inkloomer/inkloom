...
import {GeneralScene, JointScene, RecapScene} from './scenes/GuaranteePartyScenes';
...
export const GuaranteeParty = () => {
  const frame = useCurrentFrame();

  return (
    <AbsoluteFill style={{backgroundColor: PALETTE.background, overflow: 'hidden'}}>
      <BackgroundStructure />
      <SceneSequence name="01-general" {...SCENES.general}>
        <GeneralScene />
      </SceneSequence>
      <SceneSequence name="02-joint" {...SCENES.joint}>
        <JointScene />
      </SceneSequence>
