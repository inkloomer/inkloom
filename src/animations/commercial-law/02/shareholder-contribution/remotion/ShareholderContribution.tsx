...
import {Banknote, Package, XCircle, Briefcase, FileText, Timer, Zap, Lock, Hammer, User, CreditCard, Award, Heart, KeyRound, PieChart, Ban, CircleDollarSign, ShieldCheck, Scale} from 'lucide-react';
...
export const ShareholderContribution01Scene=()=>{
  ...
  return <Shell code="02.3" title="出资形式：货币 与 非货币">
    <div data-layout="contribution-docks-1" data-visual-anchor="comparison-axis" data-visual-grammar="money-dock,in-kind-dock" data-text-treatments="label-block,thin-underline,soft-highlight" data-focal-rule="shareholder-contribution-scene-01-rule" data-focal-channels="contrast,icon,spatial" style={{position:'absolute',inset:0}}>
      ...
      <div data-final-knowledge="shareholder-contribution-scene-01-dock-0" style={{position:'absolute',left:24,top:70,bottom:140,width:840,padding:26,border:'5px solid '+COLORS.green,background:COLORS.paper,opacity:enter(28,54),translate:slide(28,54,'-26px 0px'),display:'flex',flexDirection:'column'}}>
        ...
        <div style={{flex:1,display:'flex',alignItems:'center',gap:12,fontSize:25,fontWeight:800,lineHeight:1.6,padding:'14px 18px',background:COLORS.green+'12',marginBottom:12}}><CircleDollarSign size={30} color={COLORS.green} style={{flexShrink:0}}/><span>同时满足：<span style={{fontWeight:900}}>按时</span>＋<span style={{fontWeight:900}}>足额</span>＋存入公司账户</span></div>
        <div style={{flex:1,display:'flex',alignItems:'center',fontSize:25,fontWeight:800,lineHeight:1.6,padding:'14px 18px',background:COLORS.green+'12'}}><span>以违法犯罪所得货币出资的，出资<span style={{background:COLORS.green+'30',padding:'2px 6px',fontWeight:900}}>有效</span>，股东可获得股权；追缴、处罚时拍卖或变卖其股权</span></div>
      </div>
      <div data-final-knowledge="shareholder-contribution-scene-01-dock-1" style={{position:'absolute',right:24,top:70,bottom:140,width:840,padding:26,border:'5px solid '+COLORS.orange,background:COLORS.paper,opacity:enter(46,72),translate:slide(46,72,'26px 0px'),display:'flex',flexDirection:'column'}}>
        ...
        <div style={{flex:1,display:'flex',alignItems:'center',fontSize:25,fontWeight:800,lineHeight:1.6,padding:'14px 18px',background:COLORS.orange+'12',marginBottom:12}}><span>需过户登记的房屋等：<span style={{fontWeight:900}}>交付</span>＋<span style={{fontWeight:900}}>过户登记给公司</span>——自<span style={{background:COLORS.orange+'30',padding:'2px 6px',fontWeight:900}}>实际交付</span>时享有股东权利</span></div>
        <div style={{flex:1,display:'flex',alignItems:'center',fontSize:25,fontWeight:800,lineHeight:1.6,padding:'14px 18px',background:COLORS.orange+'12'}}><span>以无权处分的财产出资：公司可<span style={{fontWeight:900}}>善意取得</span>（不知情＋合理对价＋动产已交付/不动产已过户；核心管理人员知情的，视为公司知情）</span></div>
      </div>
  ...
  return <Shell code="02.3" title="禁止出资的六项">
    <div data-layout="banned-six-2" data-visual-anchor="typographic-sequence" data-visual-grammar="banned-registry,credit-debt-notes" data-text-treatments="stamp,external-negation,soft-highlight" data-focal-rule="shareholder-contribution-scene-02-rule" data-focal-channels="enclosure,motion,annotation" style={{position:'absolute',inset:0}}>
      ...
      <div style={{position:'absolute',left:0,right:0,top:80,display:'grid',gridTemplateColumns:'repeat(6,minmax(0,1fr))',gap:16}}>
        <div data-final-knowledge="shareholder-contribution-scene-02-ban-0" style={{padding:'30px 8px',border:'4px solid '+COLORS.ink,borderTop:'12px solid '+COLORS.orange,background:COLORS.paper,textAlign:'center',opacity:enter(30,56),translate:interpolate(frame,[30,56],['0px 24px','0px 0px'],CLAMP)}}>
        ...
        <div data-final-knowledge="shareholder-contribution-scene-02-ban-1" style={{padding:'30px 8px',border:'4px solid '+COLORS.ink,borderTop:'12px solid '+COLORS.orange,background:COLORS.paper,textAlign:'center',opacity:enter(42,68),translate:interpolate(frame,[42,68],['0px 24px','0px 0px'],CLAMP)}}>
        ...
        <div data-final-knowledge="shareholder-contribution-scene-02-ban-2" style={{padding:'30px 8px',border:'4px solid '+COLORS.ink,borderTop:'12px solid '+COLORS.orange,background:COLORS.paper,textAlign:'center',opacity:enter(54,80),translate:interpolate(frame,[54,80],['0px 24px','0px 0px'],CLAMP)}}>
        ...
        <div data-final-knowledge="shareholder-contribution-scene-02-ban-3" style={{padding:'30px 8px',border:'4px solid '+COLORS.ink,borderTop:'12px solid '+COLORS.orange,background:COLORS.paper,textAlign:'center',opacity:enter(66,92),translate:interpolate(frame,[66,92],['0px 24px','0px 0px'],CLAMP)}}>
        ...
        <div data-final-knowledge="shareholder-contribution-scene-02-ban-4" style={{padding:'30px 8px',border:'4px solid '+COLORS.ink,borderTop:'12px solid '+COLORS.orange,background:COLORS.paper,textAlign:'center',opacity:enter(78,104),translate:interpolate(frame,[78,104],['0px 24px','0px 0px'],CLAMP)}}>
        ...
        <div data-final-knowledge="shareholder-contribution-scene-02-ban-5" style={{padding:'30px 8px',border:'4px solid '+COLORS.ink,borderTop:'12px solid '+COLORS.orange,background:COLORS.paper,textAlign:'center',opacity:enter(90,116),translate:interpolate(frame,[90,116],['0px 24px','0px 0px'],CLAMP)}}>
      ...
      <div data-final-knowledge="shareholder-contribution-scene-02-equity" style={{position:'absolute',left:0,width:860,top:400,bottom:120,padding:'20px 26px',border:'4px solid '+COLORS.ink,background:COLORS.paper,opacity:enter(116,142),translate:interpolate(frame,[116,142],['0px 22px','0px 0px'],CLAMP)}}>
        <PieChart size={150} color={COLORS.green} strokeWidth={1.2} style={{position:'absolute',right:4,bottom:-4,opacity:0.08,pointerEvents:'none'}}/>
        <div style={{display:'flex',alignItems:'center',gap:12,fontSize:27,fontWeight:900,marginBottom:14}}><PieChart size={32} color={COLORS.green}/>股权出资四要件</div>
        <div style={{fontSize:24,fontWeight:700,lineHeight:1.8}}><span style={{fontWeight:900,color:COLORS.green,background:COLORS.green+'12',padding:'1px 6px'}}>已进行价值评估</span>；<span style={{fontWeight:900}}>合法持有并可依法转让</span>；无<span style={{fontWeight:900,color:COLORS.orange,borderBottom:'3px solid '+COLORS.orange,paddingBottom:1}}>权利瑕疵或权利负担</span>；<span style={{fontWeight:900}}>已履行股权转让手续</span></div>
      </div>
      <div data-final-knowledge="shareholder-contribution-scene-02-credit" style={{position:'absolute',right:0,width:860,top:400,bottom:120,padding:'20px 26px',border:'4px solid '+COLORS.ink,background:COLORS.paper,opacity:enter(134,160),translate:interpolate(frame,[134,160],['0px 22px','0px 0px'],CLAMP)}}>
        <FileText size={150} color={COLORS.green} strokeWidth={1.2} style={{position:'absolute',right:4,bottom:-4,opacity:0.08,pointerEvents:'none'}}/>
        <div style={{display:'flex',alignItems:'center',gap:12,fontSize:27,fontWeight:900,marginBottom:14}}><FileText size={32} color={COLORS.green}/>债权出资（债权让与）</div>
        <div style={{fontSize:24,fontWeight:700,lineHeight:1.8}}>无须征得债务人同意，但<span style={{fontWeight:900}}>应通知</span>；约定不得转让的债权——金钱债权<span style={{fontWeight:900,color:COLORS.orange,background:COLORS.orange+'14',padding:'1px 6px'}}>不得对抗第三人</span>，非金钱债权<span style={{fontWeight:900,color:COLORS.orange,background:COLORS.orange+'14',padding:'1px 6px'}}>不得对抗善意第三人</span></div>
      </div>
...
export const ShareholderContribution03Scene=()=>{
  ...
  return <Shell code="02.3" title="出资方式：认缴制 与 实缴制">
    <div data-layout="subscription-clock-3" data-visual-anchor="timeline-gate" data-visual-grammar="five-year-clock,acceleration-trigger" data-text-treatments="thin-underline,label-block,stamp" data-focal-rule="shareholder-contribution-scene-03-rule" data-focal-channels="connector,motion,enclosure" style={{position:'absolute',inset:0}}>
      ...
      <div data-final-knowledge="shareholder-contribution-scene-03-clock" style={{position:'absolute',left:0,top:70,width:860,padding:'24px 26px',border:'4px solid '+COLORS.ink,background:COLORS.paper,opacity:enter(28,54),translate:interpolate(frame,[28,54],['0px 22px','0px 0px'],CLAMP)}}>
      ...
      <div data-final-knowledge="shareholder-contribution-scene-03-interest" style={{position:'absolute',left:0,top:300,width:860,padding:'22px 26px',border:'4px solid '+COLORS.green,background:COLORS.paper,opacity:enter(46,72),translate:interpolate(frame,[46,72],['0px 20px','0px 0px'],CLAMP)}}>
        ...
        <div style={{fontSize:24,fontWeight:700,lineHeight:1.5}}>期限届满前，<span style={{fontWeight:900,color:COLORS.green,background:COLORS.green+'12',padding:'1px 6px'}}>无须提前缴纳</span></div>
      </div>
      <div data-final-knowledge="shareholder-contribution-scene-03-accelerate" style={{position:'absolute',left:0,top:500,bottom:0,width:860,padding:'22px 26px',border:'5px solid '+COLORS.orange,background:COLORS.paper,opacity:enter(108,134)}}>
      ...
      <div data-final-knowledge="shareholder-contribution-scene-03-execution" style={{position:'absolute',right:0,top:70,width:850,padding:'22px 26px',border:'3px dashed '+COLORS.orange,background:COLORS.paper,opacity:enter(64,90),translate:interpolate(frame,[64,90],['0px 20px','0px 0px'],CLAMP)}}>
      ...
      <div data-final-knowledge="shareholder-contribution-scene-03-paidup" style={{position:'absolute',right:0,top:300,width:850,padding:'22px 26px',border:'4px solid '+COLORS.ink,background:COLORS.gold+'2A',opacity:enter(80,106),translate:interpolate(frame,[80,106],['0px 20px','0px 0px'],CLAMP)}}>
      ...
      <div style={{position:'absolute',right:0,top:500,bottom:0,width:850,display:'flex',alignItems:'center',gap:16,border:'4px solid '+COLORS.ink,background:COLORS.paper,padding:'14px 26px',opacity:enter(96,124)}}>
