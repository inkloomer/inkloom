...
import {Exception1Scene, Exception2Scene, Exception3Scene, PrincipleScene, RecapScene} from './scenes/ProperPartyScenes';
...
export const ProperParty = () => {
  const frame = useCurrentFrame();

  return (
    <AbsoluteFill style={{backgroundColor: PALETTE.background, overflow: 'hidden'}}>
      <BackgroundStructure />
      <SceneSequence name="01-principle" {...SCENES.principle}>
        <PrincipleScene />
      </SceneSequence>
      <SceneSequence name="02-exception1" {...SCENES.exception1}>
        <Exception1Scene />
      </SceneSequence>
      <SceneSequence name="03-exception2" {...SCENES.exception2}>
        <Exception2Scene />
      </SceneSequence>
      <SceneSequence name="04-exception3" {...SCENES.exception3}>
        <Exception3Scene />
      </SceneSequence>
