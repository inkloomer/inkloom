...
import {SupplementInvestLoop} from '../../animations/criminal-procedure/12/supplement-invest-loop/remotion/SupplementInvestLoop';
...
import {FirstInstanceProcession} from '../../animations/criminal-procedure/15/first-instance-procession/remotion/FirstInstanceProcession';
...
import {JuvenileObservatoryGreenhouse} from '../../animations/criminal-procedure/20/juvenile-observatory-greenhouse/remotion/JuvenileObservatoryGreenhouse';
...
import {DURATION_FRAMES as DISPUTE_SETTLEMENT_DURATION_FRAMES, FPS as DISPUTE_SETTLEMENT_FPS} from '../../animations/international-law/07/dispute-settlement/remotion/storyboard';
...
export const STYLE_DEMOS = [
  ...
  {id: 'criminal-procedure-20-juvenile-observatory-greenhouse', slug: 'juvenile-observatory-greenhouse', title: '观护温室', direction: 'Observatory Greenhouse Juvenile', component: JuvenileObservatoryGreenhouse, href: '/inkloom/objective/criminal-procedure/20/juvenile-observatory-greenhouse/', durationInFrames: JUVENILE_GREENHOUSE_DURATION_FRAMES, fps: JUVENILE_GREENHOUSE_FPS},
...
const DEMO_ADDED_AT: Record<(typeof STYLE_DEMOS)[number]['id'], string> = {
  ...
  'criminal-procedure-20-juvenile-observatory-greenhouse': '2026-08-29T22:20:00+08:00',
