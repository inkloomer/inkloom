...
import {DURATION_FRAMES as DURATION_01, FPS as FPS_01} from '../../animations/commercial-law/01/company-personality/remotion/storyboard';
import {CompanyClassification} from '../../animations/commercial-law/01/company-classification/remotion/CompanyClassification';
import {DURATION_FRAMES as DURATION_02, FPS as FPS_02} from '../../animations/commercial-law/01/company-classification/remotion/storyboard';
import {CompanyCapacity} from '../../animations/commercial-law/01/company-capacity/remotion/CompanyCapacity';
import {DURATION_FRAMES as DURATION_03, FPS as FPS_03} from '../../animations/commercial-law/01/company-capacity/remotion/storyboard';
...
import {DURATION_FRAMES as DURATION_06, FPS as FPS_06} from '../../animations/commercial-law/02/shareholder-contribution/remotion/storyboard';
import {LlcEquityTransfer} from '../../animations/commercial-law/07/llc-equity-transfer/remotion/LlcEquityTransfer';
import {DURATION_FRAMES as DURATION_15, FPS as FPS_15} from '../../animations/commercial-law/07/llc-equity-transfer/remotion/storyboard';
import {BankruptcyGrounds} from '../../animations/commercial-law/09/bankruptcy-grounds/remotion/BankruptcyGrounds';
import {DURATION_FRAMES as DURATION_19, FPS as FPS_19} from '../../animations/commercial-law/09/bankruptcy-grounds/remotion/storyboard';
...
import {DURATION_FRAMES as DURATION_28, FPS as FPS_28} from '../../animations/commercial-law/11/bankruptcy-revocation-right/remotion/storyboard';
...
import {DURATION_FRAMES as DURATION_29, FPS as FPS_29} from '../../animations/commercial-law/12/bankruptcy-reorganization/remotion/storyboard';
import {BankruptcyLiquidation} from '../../animations/commercial-law/12/bankruptcy-liquidation/remotion/BankruptcyLiquidation';
import {DURATION_FRAMES as DURATION_30, FPS as FPS_30} from '../../animations/commercial-law/12/bankruptcy-liquidation/remotion/storyboard';
...
export const COMMERCIAL_LAW_STYLE_DEMOS = [
  ...
  {id: 'commercial-law-01-company-classification', slug: 'company-classification', title: '双轨法人谱系', direction: 'branch-charter', component: CompanyClassification, href: '/inkloom/objective/commercial-law/01/company-classification/', durationInFrames: DURATION_02, fps: FPS_02},
  {id: 'commercial-law-01-company-capacity', slug: 'company-capacity', title: '担保决议柜', direction: 'resolution-cabinet', component: CompanyCapacity, href: '/inkloom/objective/commercial-law/01/company-capacity/', durationInFrames: DURATION_03, fps: FPS_03},
  {id: 'commercial-law-02-shareholder-contribution', slug: 'shareholder-contribution', title: '出资泊位港', direction: 'contribution-dockyard', component: ShareholderContribution, href: '/inkloom/objective/commercial-law/02/shareholder-contribution/', durationInFrames: DURATION_06, fps: FPS_06},
  {id: 'commercial-law-07-llc-equity-transfer', slug: 'llc-equity-transfer', title: '股权流转市集', direction: 'transfer-mart', component: LlcEquityTransfer, href: '/inkloom/objective/commercial-law/07/llc-equity-transfer/', durationInFrames: DURATION_15, fps: FPS_15},
  {id: 'commercial-law-09-bankruptcy-grounds', slug: 'bankruptcy-grounds', title: '破产诊断台', direction: 'insolvency-diagnosis', component: BankruptcyGrounds, href: '/inkloom/objective/commercial-law/09/bankruptcy-grounds/', durationInFrames: DURATION_19, fps: FPS_19},
  {id: 'commercial-law-11-bankruptcy-revocation-right', slug: 'bankruptcy-revocation-right', title: '临界期日历', direction: 'critical-period-calendar', component: BankruptcyRevocationRight, href: '/inkloom/objective/commercial-law/11/bankruptcy-revocation-right/', durationInFrames: DURATION_28, fps: FPS_28},
  {id: 'commercial-law-12-bankruptcy-reorganization', slug: 'bankruptcy-reorganization', title: '重整轨道', direction: 'reorganization-rail', component: BankruptcyReorganization, href: '/inkloom/objective/commercial-law/12/bankruptcy-reorganization/', durationInFrames: DURATION_29, fps: FPS_29},
