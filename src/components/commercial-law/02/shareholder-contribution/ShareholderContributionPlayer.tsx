...
const scenes:readonly RemotionScene[]=[
  ...
  {id: 'shareholder-contribution-scene-04', number: '03', title: '股权出资与债权出资', ...SCENES['shareholder-contribution-scene-04']},
  {id: 'shareholder-contribution-scene-03', number: '04', title: '认缴制与实缴制', ...SCENES['shareholder-contribution-scene-03']},
];
