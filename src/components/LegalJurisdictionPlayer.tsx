...
const scenes: readonly RemotionScene[] = [
  ...
  {number: '02', title: '哪些争议归法院？', ...SCENES.scope},
  {number: '03', title: '三种纠纷处理关系', ...SCENES.relations},
  {number: '04', title: '人民调解与司法确认', ...SCENES.mediation},
  {number: '05', title: '仲裁：或裁或审', ...SCENES.arbitration},
  {number: '06', title: '劳动仲裁前置', ...SCENES.labor},
  {number: '07', title: '最终关系图', ...SCENES.recap},
];
