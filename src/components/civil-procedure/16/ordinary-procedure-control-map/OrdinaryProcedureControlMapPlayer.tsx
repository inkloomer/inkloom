...
const scenes: readonly RemotionScene[] = [
  ...
  {id: 'repeat-suit-test', number: '02', title: '重复起诉的合流检验', ...SCENES.repeatSuitTest},
  {id: 'withdrawal-absence', number: '03', title: '撤诉与缺席判决的角色边界', ...SCENES.withdrawalAbsence},
  {id: 'procedural-obstacles', number: '04', title: '三类诉讼障碍的边界', ...SCENES.proceduralObstacles},
  {id: 'judgment-documents', number: '05', title: '裁判文书与纠错出口', ...SCENES.judgmentDocuments},
  {id: 'judgment-effects', number: '06', title: '判决效力的条件与范围', ...SCENES.judgmentEffects},
  {id: 'marriage-validity-boundary', number: '07', title: '婚姻效力诉讼的特殊边界', ...SCENES.marriageValidityBoundary},
];
