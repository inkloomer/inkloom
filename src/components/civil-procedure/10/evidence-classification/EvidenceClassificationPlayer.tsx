...
const scenes: readonly RemotionScene[] = [
  {id: 'origin-derived', number: '01', title: '原始证据 vs 传来证据', ...SCENES.originDerived},
  {id: 'direct-indirect', number: '02', title: '直接证据 vs 间接证据', ...SCENES.directIndirect},
  {id: 'burden-evidence', number: '03', title: '本证 vs 反证三步判断', ...SCENES.burdenEvidence},
  {id: 'single-case-trap', number: '04', title: '不能单独定案的逆命题误区', ...SCENES.singleCaseTrap},
  {id: 'proof-threshold', number: '05', title: '本证要达标，反证无需登顶', ...SCENES.proofThreshold},
  {id: 'out-of-scope-evidence', number: '06', title: '无关事实不是本案证据', ...SCENES.outOfScopeEvidence},
];
