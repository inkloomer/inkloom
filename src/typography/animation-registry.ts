...
import {typography as typographyAutoCoOwnershipHall} from '../animations/civil-law/07/co-ownership-hall/animation.meta';
import {typography as typographyAutoPremisesOwnershipHall} from '../animations/civil-law/07/premises-ownership-hall/animation.meta';
import {typography as typographyAutoUsefructRightsHall} from '../animations/civil-law/08/usefruct-rights-hall/animation.meta';
import {typography as typographyAutoPossessionHall} from '../animations/civil-law/09/possession-hall/animation.meta';
import {typography as typographyAutoObligationClassificationHall} from '../animations/civil-law/10/obligation-classification-hall/animation.meta';
...
import {typography as typographyAutoCreditSaleTrilogyHall} from '../animations/civil-law/12/credit-sale-trilogy-hall/animation.meta';
import {typography as typographyAutoSpecialSaleMiscHall} from '../animations/civil-law/12/special-sale-misc-hall/animation.meta';
import {typography as typographyAutoGiftLoanHall} from '../animations/civil-law/12/gift-loan-hall/animation.meta';
import {typography as typographyAutoLeaseFormStatusHall} from '../animations/civil-law/12/lease-form-status-hall/animation.meta';
import {typography as typographyAutoLeaseProtectionHall} from '../animations/civil-law/12/lease-protection-hall/animation.meta';
...
import {typography as typographyAutoPersonalityShieldHall} from '../animations/civil-law/17/personality-shield-hall/animation.meta';
import {typography as typographyAutoPersonalityReinsHall} from '../animations/civil-law/16/personality-reins-hall/animation.meta';
import {typography as typographyAutoGuaranteeDepositSealDesk} from '../animations/civil-law/15/guarantee-deposit-seal-desk/animation.meta';
import {typography as typographyAutoGuaranteeAtriumBronzeware} from '../animations/civil-law/13/guarantee-atrium-bronzeware/animation.meta';
...
const ANIMATION_TYPOGRAPHY_CONFIGURATIONS: Readonly<Record<string, AnimationTypographyConfiguration>> = {
  ...
  'marriage-validity-chain': {metadata: typographyAutoMarriageValidityChain, scope: {animationId: 'marriage-validity-chain', subject: 'civil-law', topic: '20'}},
  ...
  'personality-shield-hall': {metadata: typographyAutoPersonalityShieldHall, scope: {animationId: 'personality-shield-hall', subject: 'civil-law', topic: '17'}},
  'personality-reins-hall': {metadata: typographyAutoPersonalityReinsHall, scope: {animationId: 'personality-reins-hall', subject: 'civil-law', topic: '16'}},
  'guarantee-deposit-seal-desk': {metadata: typographyAutoGuaranteeDepositSealDesk, scope: {animationId: 'guarantee-deposit-seal-desk', subject: 'civil-law', topic: '15'}},
  'guarantee-atrium-bronzeware': {metadata: typographyAutoGuaranteeAtriumBronzeware, scope: {animationId: 'guarantee-atrium-bronzeware', subject: 'civil-law', topic: '13'}},
  ...
  'occupation-accession-hall': {metadata: typographyAutoOccupationAccessionHall, scope: {animationId: 'occupation-accession-hall', subject: 'civil-law', topic: '07'}},
  'co-ownership-hall': {metadata: typographyAutoCoOwnershipHall, scope: {animationId: 'co-ownership-hall', subject: 'civil-law', topic: '07'}},
  'premises-ownership-hall': {metadata: typographyAutoPremisesOwnershipHall, scope: {animationId: 'premises-ownership-hall', subject: 'civil-law', topic: '07'}},
  'usefruct-rights-hall': {metadata: typographyAutoUsefructRightsHall, scope: {animationId: 'usefruct-rights-hall', subject: 'civil-law', topic: '08'}},
  'possession-hall': {metadata: typographyAutoPossessionHall, scope: {animationId: 'possession-hall', subject: 'civil-law', topic: '09'}},
  'obligation-classification-hall': {metadata: typographyAutoObligationClassificationHall, scope: {animationId: 'obligation-classification-hall', subject: 'civil-law', topic: '10'}},
  ...
  'credit-sale-trilogy-hall': {metadata: typographyAutoCreditSaleTrilogyHall, scope: {animationId: 'credit-sale-trilogy-hall', subject: 'civil-law', topic: '12'}},
  'special-sale-misc-hall': {metadata: typographyAutoSpecialSaleMiscHall, scope: {animationId: 'special-sale-misc-hall', subject: 'civil-law', topic: '12'}},
  'gift-loan-hall': {metadata: typographyAutoGiftLoanHall, scope: {animationId: 'gift-loan-hall', subject: 'civil-law', topic: '12'}},
  'lease-form-status-hall': {metadata: typographyAutoLeaseFormStatusHall, scope: {animationId: 'lease-form-status-hall', subject: 'civil-law', topic: '12'}},
  'lease-protection-hall': {metadata: typographyAutoLeaseProtectionHall, scope: {animationId: 'lease-protection-hall', subject: 'civil-law', topic: '12'}},
